...
plot('EBITDA Actual by Quarter by Business Unit', height=300, use_container_width=True, show_title=False)

split_cols = st.columns(2)
with split_cols[0]:
    plot('Actual by Account Category', height=430, use_container_width=True, show_title=False)
with split_cols[1]:
    plot('Actual by Country', height=430, use_container_width=True, show_title=False)

plot('Gross Margin by Quarter by Business Unit', show_title=False)
